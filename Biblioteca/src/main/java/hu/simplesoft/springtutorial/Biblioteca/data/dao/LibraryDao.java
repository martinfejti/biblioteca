...
public interface LibraryDao {
	...
	void updateLibrary(LibraryDto libraryDto) throws PersistenceException;
	void deleteLibrary(long libraryId) throws PersistenceException;
	LibraryDto getLibraryById(long libraryId) throws ElementNotFoundException;
