...
public interface AddressService {
	...
	void updateAddress(AddressDto addressDto) throws ServiceException, ObjectIsNullException;
	void deleteAddress(long addressId) throws ServiceException, ObjectIsNullException;
	AddressDto getAddressById(long addressId) throws ServiceException, ObjectIsNullException;
